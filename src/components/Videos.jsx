    ...
    <div className='container-videos d-flex flex-column-reverse flex-md-row'>
      ...
      <div className='container-parrafo-video col-md-6'>
        <p className='text-center text-warning fw-bold p-2 animated-text-tres'>
          ...
          me ha permitido desarrollar la capacidad de crear una sólida base de datos. Esta base de
          datos tiene como objetivo principal almacenar información sobre los socios de la agrupación
          cultural con Personería Jurídica (<span className="text-color-uno">P.J.</span>), en la que
          desempeño roles tanto como director como socio activo.
        </p>
